...
//* Fire-and-forget: todas las excepciones se capturan internamente para que
//* un fallo en ms-Logs nunca interrumpa la operación principal del MS Usuario
@Component
public class LogClient {

    private static final Logger logger = LoggerFactory.getLogger(LogClient.class);
    private static final String SERVICIO = "ms-usuario";
    ...
    //* Registra un evento en ms-Logs. Nunca lanza excepción.
    //  tipo:      ERROR | WARNING | INFO | DEBUG | AUTENTICACION
    //  mensaje:   descripción del evento
    //  idUsuario: ID del usuario relacionado (null para eventos del sistema)
    //  detalle:   stack trace, payload extra o detalle adicional (null si no aplica)
